...
public class ListSenimanDetailEventActivity extends AppCompatActivity {
    ...
    public void getData(){
        ...
        final int id_event = dataExtra.getInt("id_event");

        urlRead += "?id_event="+String.valueOf(id_event);
                ...
                try{
                    ...
                    for (int i = 0; i < jr.length(); i++) {
                        try {
                            ...
                            PojoSeniman seniman = new PojoSeniman(obj.getInt("id_seniman"),obj.getInt("id_event"),obj.getString("nama"),obj.getString("jenis_kelamin"),obj.getString("portfolio"),obj.getString("no_hp"),obj.getString("umur"), DatabaseConnection.getBaseUrl() + obj.getString("foto"),obj.getString("keahlian_spesifik"),obj.getString("format_solo_grup"), obj.getString("status"));
