...
import com.artace.ruangbudaya.adapter.ListTawaranAdapter;
...
//    private OnFragmentInteractionListener mListener;
    ...
    public void getEvents(){
        ...
        String id_kelompok_seniman = sharedpreferences.getString(Field.getIdKelompokSeniman(),null);
        if (id_kelompok_seniman == null){

        }
            urlRead += "?id_kelompok_seniman=" + sharedpreferences.getString(Field.getIdKelompokSeniman(), null);
                ...
                try{
                    ...
                    for (int i = 0; i < jr.length(); i++) {
                        try {
                            ...
                            PojoListTawaran event = new PojoListTawaran(obj.getInt("id_tawaran_tampil"), obj.getInt("id_acara") , obj.getInt("id_kelompok_seniman"), obj.getInt("id_penyelenggara_acara"), obj.getString("harga"), obj.getString("status"), obj.getString("nama"), obj.getString("tanggal"), obj.getString("lokasi"), obj.getString("keterangan"), obj.getString("foto"), obj.getString("eo"), obj.getString("nama_eo"));
                            Log.e("asd","aaaa");
