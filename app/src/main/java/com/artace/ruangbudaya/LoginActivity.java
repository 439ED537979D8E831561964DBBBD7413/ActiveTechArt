                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        if(response.getString(Field.getJenisUser()).equals("seniman")){
                            String id_kelompok_seniman = Field.getIdKelompokSeniman();
                            String id_bidang_seni = Field.getIdBidangSeni();
                            ...
                            String id_penyelenggara_acara = Field.getIdPenyelenggaraAcara();
                            String email = Field.getEMAIL();

                            editor.putString(id_penyelenggara_acara, response.getString(id_penyelenggara_acara));
