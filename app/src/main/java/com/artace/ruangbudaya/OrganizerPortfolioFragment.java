                ...
                try{
                    ...
                    for (int i = 0; i < jr.length(); i++) {
                        try {
                            ...
                            PojoSeniman event = new PojoSeniman(obj.getInt("id_seniman"),obj.getInt("id_jenis_seniman"),obj.getInt("id_user"),obj.getString("nama"),obj.getString("portfolio"),obj.getString("no_hp"), DatabaseConnection.getBaseUrl() + obj.getString("foto"));
